...
2) in Server-side, run RMIRegistry using: start rmiregistry, an additional prompt will be opened and rmiregistry will be running on it. Do not close it until the demonstration is not finished.
